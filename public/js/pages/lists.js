...
var Lists = {
     ...
     * @param details
     */
    postReport: function(user_id, post_id, message_id, stream_id, story_id, type, details){
        $.ajax({
            type: 'POST',
            data: {
                user_id,
     ...
     * @param stream_id
     */
    showReportBox: function(user_id, post_id = null, message_id = null, stream_id = null, story_id = null) {
