        ...
        <div class="d-flex">
            ...
            <div class="post-details pl-2 w-100{{$post->is_pinned ? '' : '' }}">
                <div class="d-flex justify-content-between">
                    <div>
                        <div class="text-bold max-width-150 text-truncate"><a href="{{route('profile',['username'=>$post->user->username])}}" class="text-dark-r">{{$post->user->name}}</a></div>
            ...
            @if(PostsHelper::isPostSubscriptionUnlocked($post))
                ...
                @else
                    @if(count($post->attachments) > 1)
                        <div class="swiper mySwiper pointer-cursor">
