                    ...
                    <div class="modal-body">
                        ...
                        <div id="accordion" class="mb-3">
                            <div class="card">
                                ...
                                <div id="billingInformation" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="individual" class="tab-pane fade show active pt-1">
                                                        ...
                                                        <div class="col-sm-6 col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="firstName"
                                                                    ...
                                                                    required class="form-control uifield-first_name">
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="2" type="text" name="billingAddress"
                                                            onblur="checkout.validateBillingAddressField()"
                                                            placeholder="{{__('Street address, apartment, suite, unit')}}"
                        ...
                        <div>
                            <h6 class="font-weight-bolder d-flex align-items-center">
                                ...
                                {{-- <span class="to-tooltip"
                                    title="{{__('After clicking the button, you’ll be taken to a secure payment page and then redirected back to the website once payment is complete.')}}">--}}
                                    {{--
                            ...
                            <div class="d-flex text-left radio-group row px-2 my-2">
                                @if(getSetting('payments.stripe_secret_key') && getSetting('payments.stripe_public_key') && !getSetting('payments.stripe_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 stripe-payment-method">
                                        <div class="radio mx-auto stripe-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="stripe">
                                ...
                                @if(config('paypal.client_id') && config('paypal.secret') && !getSetting('payments.paypal_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 paypal-payment-method">
                                        <div class="radio mx-auto paypal-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="paypal">
                                ...
                                @if(getSetting('payments.coinbase_api_key') && !getSetting('payments.coinbase_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none coinbase-payment-method">
                                        <div class="radio mx-auto coinbase-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="coinbase">
                                ...
                                @if(getSetting('payments.nowpayments_api_key') && !getSetting('payments.nowpayments_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none nowpayments-payment-method">
                                        <div class="radio mx-auto nowpayments-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                ...
                                @if(\App\Providers\PaymentsServiceProvider::ccbillCredentialsProvided())
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none ccbill-payment-method">
                                        <div class="radio mx-auto ccbill-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="ccbill">
                                ...
                                @if(getSetting('payments.paystack_secret_key') && !getSetting('payments.paystack_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none paystack-payment-method">
                                        <div class="radio mx-auto paystack-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="paystack">
                                ...
                                @if(getSetting('payments.stripe_secret_key') && getSetting('payments.stripe_public_key') && !getSetting('payments.stripe_checkout_disabled') && getSetting('payments.stripe_oxxo_provider_enabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none oxxo-payment-method">
                                        <div class="radio mx-auto oxxo-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="oxxo">
                                ...
                                @if(getSetting('payments.mercado_access_token') && !getSetting('payments.mercado_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 d-none mercado-payment-method">
                                        <div class="radio mx-auto mercado-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="mercado">
                                ...
                                @if(getSetting('payments.verotel_merchant_id') && getSetting('payments.verotel_shop_id') && getSetting('payments.verotel_signature_key') && !getSetting('payments.verotel_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 d-none verotel-payment-method">
                                        <div class="radio mx-auto verotel-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="verotel">
                                ...
                                @if(getSetting('payments.razorpay_api_key') && getSetting('payments.razorpay_api_secret') && !getSetting('payments.razorpay_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 d-none razorpay-payment-method">
                                        <div class="radio mx-auto razorpay-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="razorpay">
                                ...
                                @if(config('asaas.api_key'))
                                    <div class="p-1 col-6 col-md-3 d-none asaas-pix-payment-method">
                                        <div class="radio mx-auto asaas-pix-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="asaas_pix">
                                            <b>{{__("PIX")}}</b>
                                        </div>
                                    </div>
                                    <div class="p-1 col-6 col-md-3 d-none asaas-boleto-payment-method">
                                        <div class="radio mx-auto asaas-boleto-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                            data-value="asaas_boleto">
                                            <b>{{__("Boleto")}}</b>
                                        </div>
                                    </div>
                                @endif
                                <div class="credit-payment-method p-1 col-6 col-md-3 col-lg-3 col-md-3" {!! !Auth::check() || Auth::user()->wallet->total <= 0 ? 'data-toggle="tooltip" data-placement="right"' : '' !!}
                                    title="{{__('You can use the wallet deposit page to add credit.')}}">
                                    <div class="radio mx-auto credit-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center my-0"
                                        data-value="credit">
                        ...
                        <p class="text-muted mt-1 small mb-0">
                            {{__('After clicking the button, you’ll be taken to a secure payment page and then redirected back to the website once payment is complete.')}}
                        </p>
                    </div>
